...
function fold(){
    ...
    if (tToggle % 2 == 0){
        foldableTop.style.transform = 'rotateX(180deg)';
        foldableBot.style.transform = 'rotateX(-180deg)';
        hLogo.style.transform = 'translate(50%, -55vh) scale(0.5)';
    }else{
        foldableTop.style.transform = 'rotateX(0deg)';
        foldableBot.style.transform = 'rotateX(0deg)';
